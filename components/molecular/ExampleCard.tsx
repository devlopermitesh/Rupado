...
const ExampleCard = ({ id, image, title, describe, isTrending, copyCount, tags }: {
    id: number;
    image: string[];
    title: string;
    describe: string;
    ...
    return (
        <div className="relative rounded-lg aspect-[4/5] overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-full h-24  
                ...
                <button
                    onClick={() => alert("hw")}
                    className="bg-foreground text-black capitalize font-ui text-sm cursor-pointer border border-white z-50 rounded-full mt-1 py-1 pointer-events-auto"
                >
                    view prompt
                </button>
            </div>
