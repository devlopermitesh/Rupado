  ...
  return (
    ...
    >
      <div className="flex flex-col w-full gap-2">
        ...
        <p className="font-ui font-normal text-sm  sm:text-base text-white/90">
          No filters. No editing skills. Just better-tested AI prompts that actually work.
        </p>
        ...
        <div className="flex flex-row justify-between items-center">
          ...
          <span className="flex flex-row gap-2 text-white">
            ...
            >
              <Twitter
                className="bg-black border border-gray-700 p-1 rounded shadow shadow-gray-600"
                size={35}
              />
            </a>
