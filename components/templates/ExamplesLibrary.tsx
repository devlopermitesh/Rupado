...
const ExamplesLibrary = () => {
    const Examples = [
        {
            id: 1,
            image: ["https://i.ibb.co/wN738sX0/Screenshot-2026-01-18-142442.png", "https://i.ibb.co/jv7CD15P/Screenshot-2026-01-18-111202.png"],
            title: "Vintage Bollywood",
            describe: "Turn any selfie into a classic Bollywood diva in red saree – vintage glamour, flawless skin, cinematic vibes.",
            copyCount: 0,
            isTrending: true,
            tags: "Studio"
        },
    ...
    return (
        <div className="w-full min-h-[60vh] px-2 sm:px-4 py-8 bg-background">
            <h2 className="text-2xl font-ui font-semibold">
                Example Library
            </h2>
